...
interface EmptyStateProps {
  title: string;
  description?: string;
  icon?: "users" | "building" | "briefcase" | "kanban" | "receipt" | "default";
...
const icons: Record<string, React.ReactNode> = {
  ...
  kanban: (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect width="6" height="10" x="9" y="5" rx="1" />
      <rect width="6" height="16" x="16" y="5" rx="1" />
    </svg>
  ),
  receipt: (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function EmptyState({ title, description, icon = "default", action }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center animate-fade-in">
      <div className="rounded-2xl bg-surface-light/50 p-5 mb-5">
