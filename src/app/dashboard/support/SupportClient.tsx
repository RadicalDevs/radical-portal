...
export default function SupportClient({ hasScores }: { hasScores: boolean }) {
  const { t } = useLanguage();
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-16 sm:px-8">
        <div className="mx-auto w-full max-w-md text-center">
          ...
          <h1 className="mt-6 font-heading text-2xl font-bold text-heading">
            {t("coaching_not_available")}
          </h1>
          <p className="mt-3 text-muted">
            {t("coaching_need_apac")}
          </p>
          <Link
            href="/apac"
  ...
  const cards = [
    {
      title: t("coaching_apac_review"),
      description: t("coaching_apac_review_desc"),
      icon: (
    ...
    {
      title: t("coaching_development"),
      description: t("coaching_development_desc"),
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: t("coaching_career"),
      description: t("coaching_career_desc"),
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const faqs = [
    { q: t("coaching_faq1_q"), a: t("coaching_faq1_a") },
    { q: t("coaching_faq2_q"), a: t("coaching_faq2_a") },
    { q: t("coaching_faq3_q"), a: t("coaching_faq3_a") },
  ];
          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-smaragd">
                {t("coaching_nelieke_role")}
              </p>
              <p className="mt-3 text-body leading-relaxed">
                {t("coaching_nelieke_bio")}
              </p>
              <p className="mt-3 text-body leading-relaxed">
                {t("coaching_nelieke_sessions")}
              </p>
            </div>
          </div>
        </div>
